...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 1968663538L;
    ...
    public final umc_7th.spring.domain.QMember member;

    public final umc_7th.spring.domain.QMission mission;

    public final EnumPath<umc_7th.spring.domain.enums.MissionStatus> status = createEnum("status", umc_7th.spring.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc_7th.spring.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umc_7th.spring.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
